...
-   Date downloaded: February 9, 2026
...
This data contains measures of Arctic ocean water components at various depths in 2008. The most important values for us are nitrate, nitrite, ammonia, and phosphorous. To get an idea of the health of the water, we have to calculate the Redfield Ratio, which is the ratio of Nitrogen : Phosphorus. Nitrogen is present in nitrate, nitrite, and ammonia, so we add them together for the ratio calculation. These elements are essential in the ocean's ability to support organic life, and are depleted at the ocean's surface and regenerated in the depths with the decomposition of marine snow. Nitrate/oxygen and Phosphorus/oxygen increase with the age of the water, and are present in overall constant proportions (the Redfield Ratio) which makes comparison across sites and time easier.
...
Figure 1 describes a positive relationship between total nitrogen vs phosphate in the ocean water samples. There is a series of clustered outliers where nitrogen is significantly higher than phosphate at that concentration. These samples could have been collected at a different depth or location, and may need to be excluded from the final analysis.
